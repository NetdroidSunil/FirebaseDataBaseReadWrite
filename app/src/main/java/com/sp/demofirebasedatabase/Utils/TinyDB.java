package com.sp.demofirebasedatabase.Utils;
...
public class TinyDB {
     ...
     *               "DropBox/WorkImages"
     * @param String the theImageName - the name you want to assign to the image
     *               file e.g "MeAtlunch.png"
     */
    ...
    public void putListDouble(String key, ArrayList<Double> marray) {
        ...
        editor.putString(key,
                TextUtils.join("â€šâ€—â€š", mystringlist));
        editor.apply();
    }
    ...
    public boolean getBoolean(String key, boolean aTrue) {
